              ...
              <div className="flex flex-1 flex-col">
                ...
                {project.demo && /(^|\.)t\.me\//.test(project.demo) && (
                  <div className="mb-4 rounded-lg bg-neutral-50 p-3 dark:bg-neutral-800">
                    <SocialStats
                      platform="telegram"
                      channelUsername="english_with_omarr"
                    />
                  </div>
                )}
                ...
                <div className="mb-6 flex flex-wrap gap-2">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="rounded-md bg-primary-50 px-2 py-1 text-xs font-medium text-primary-700 dark:bg-primary-100/20 dark:text-primary-100"
                    >
                      {tech}
                    </span>
                  ))}
