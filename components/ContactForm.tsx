              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-primary-700 transition-colors duration-200 hover:text-primary-800 dark:text-primary-100 dark:hover:text-primary-50"
                  >
                    {profile.email}
                  </a>
                </div>
                ...
                <div className="pointer-events-none absolute left-1/2 top-1/2 z-30 -translate-x-1/2 -translate-y-1/2">
                  <div className="strobe-warning mx-auto w-max rounded-lg border border-yellow-300 bg-yellow-50/95 px-4 py-3 text-yellow-900 shadow-xl dark:border-yellow-700 dark:bg-yellow-900/90 dark:text-yellow-100">
                    <div className="flex flex-col items-center text-center">
                      <div className="strobe-icon-red strobe-delay-half relative mb-2 h-8 w-8">
                        <Image
